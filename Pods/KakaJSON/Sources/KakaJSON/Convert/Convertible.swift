...
public extension Convertible {
    ...
    func kj_modelType(from _: Any?,
                      _: Property) -> Convertible.Type? { return nil }
    func kj_willConvertToModel(from _: [String: Any]) {}
    func kj_didConvertToModel(from _: [String: Any]) {}
    ...
    func kj_willConvertToJSON() {}
    func kj_didConvertToJSON(json _: [String: Any]) {}
}
...
public extension Convertible {
    ...
    var kj_m: ConvertibleKJ_M<Self> {
        mutating get { ConvertibleKJ_M(&self) }
        set {}
    }
}
