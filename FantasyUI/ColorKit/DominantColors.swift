...
public extension UIImage {
    ...
    func dominantColors(with quality: DominantColorQuality = .fair, algorithm: DominantColorAlgorithm = .iterative) throws -> [UIColor] {
        switch algorithm {
        case .iterative:
    ...
    func dominantColorFrequencies(with quality: DominantColorQuality = .fair) throws -> [ColorFrequency] {
        // ------
