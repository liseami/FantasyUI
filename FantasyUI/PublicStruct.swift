...
public struct ICON: View, Equatable {
    public static func == (lhs: ICON, rhs: ICON) -> Bool {
        lhs.name == rhs.name && lhs.sysname == rhs.sysname
    }
...
public struct PF_AsyncImage: View {
    ...
    func dataToImage(completion: @escaping (Image) -> Void) {
...
public struct PF_MenuBtn: View {
    ...
    public init(text: String, sysname: String, action: @escaping () -> Void) {
        self.text = text
        self.sysname = sysname
        self.action = action
        name = nil
    ...
    public init(text: String, name: String, action: @escaping () -> Void) {
        self.text = text
        self.name = name
        self.action = action
        sysname = nil
