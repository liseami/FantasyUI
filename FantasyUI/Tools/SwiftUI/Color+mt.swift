...
public extension MT where Base == SwiftUI.Color {
    ...
    // fc1
    static var fc0 = MTColor.fc0.value
    static var fc1 = MTColor.fc1.value
    static var fc2 = MTColor.fc2.value
    static var fc3 = MTColor.fc3.value
    static var fc4 = MTColor.fc4.value
}
...
extension UIColor: MTCompatible {
    static var MainColor = Color(hex: "4850FF")
...
public extension MT where Base == UIColor {
    ...
    static var fc0 = MTColor.fc0.uicolor
    static var fc1 = MTColor.fc1.uicolor
    static var fc2 = MTColor.fc2.uicolor
    static var fc3 = MTColor.fc3.uicolor
    static var fc4 = MTColor.fc4.uicolor
}
